// GabLuchi button injection (standalone plugin)
...
(function () {
  ...
  // ALL GabLuchi overlays that should block Steam navigation
  const OVERLAY_SELECTORS = [
    ".gabluchi-overlay",
    ".gabluchi-settings-overlay",
    ".gabluchi-alert-overlay",
    ".gabluchi-confirm-overlay",
  ...
  function isBigPictureMode() {
    if (typeof window.__GABLUCHI_IS_BIG_PICTURE__ !== "undefined") {
      return window.__GABLUCHI_IS_BIG_PICTURE__;
    }
  ...
  function scanFocusableElements() {
    ...
    // Only scan if there's a GabLuchi overlay active
    const activeOverlay = document.querySelector(OVERLAY_SELECTOR_STRING);

    if (!activeOverlay) {
      console.log("[Gamepad] No GabLuchi overlay active, skipping scan");
  ...
  function pollGamepad() {
    ...
    // Check if there's an active GabLuchi overlay
...
(function () {
  ...
  // re-injects this whole script whenever window.__GabLuchiReady isn't true yet — which can happen
  // while THIS injection's own async setup is still in flight (see the retry loop in
  // addGabLuchiButton() and where __GabLuchiReady actually gets set, near the end of this IIFE). Without
  ...
  window.__GabLuchiFrontendVersion = "1.0.4";
  ...
  // ============================================================
  // GabLuchi GUI backend shim
  // ------------------------------------------------------------
  // The old Lua/Millennium backend is gone. The GabLuchi GUI desktop app is now
  ...
  const Millennium = (function () {
    ...
    const call = (method, args) =>
      window.Millennium.callServerMethod("gabluchi", method, args || {}).then(
        (res) => (typeof res === "string" ? JSON.parse(res) : res),
      );

    const map = {
      // ── Real endpoints (GabLuchi GUI HTTP server) ──
      HasGabLuchiForApp: (a) => call("HasGabLuchiForApp", { appid: aid(a) }),
      DeleteGabLuchiForApp: (a) => call("DeleteGabLuchiForApp", { appid: aid(a) }),
      CancelAddViaGabLuchi: (a) => call("CancelAddViaGabLuchi", { appid: aid(a) }),
      ...
      GetIconDataUrl: () => Promise.resolve({ success: true, dataUrl: "data:image/png;base64," }),
      CheckForFixes: () =>
  ...
  window.__GABLUCHI_IS_BIG_PICTURE__ = isBigPictureMode();
  ...
  function backendLog(message) {
    try {
      if (
        ...
        Millennium.callServerMethod("gabluchi", "Logger.log", {
          message: String(message),
        });
      }
    } catch (err) {
      if (typeof console !== "undefined" && console.warn) {
        console.warn("[GabLuchi] backendLog failed", err);
      }
    }
  }
  ...
  function startGabLuchiAdd(appid, anchor) {
    ...
    window.Millennium.callServerMethod("gabluchi", "StartGabLuchiAdd", {
      appid,
    ...
    const renderSources = function (sources, clickable) {
      ...
      sources.forEach(function (s) {
        ...
        item.className = "gabluchi-api-item";
        item.setAttribute("data-api-name", s.name);
        item.style.cssText =
          "display:flex;align-items:center;justify-content:space-between;padding:9px 12px;margin-bottom:6px;background:transparent;border:1px solid " +
          colors.hairline +
          ";border-radius:4px;transition:background 0.15s ease, border-color 0.15s ease;";
        ...
        if (clickable && s.canDownload && !s.downloading) {
          ...
          item.onmouseover = function () {
            item.style.background = colors.hoverBg;
            item.style.borderColor = colors.hairline;
          };
          ...
          item.onclick = function () {
            ...
            picking = true;
            renderKey = "";
            const st = q(".gabluchi-status");
            if (st) st.textContent = lt("Starting download…");
            window.Millennium.callServerMethod("gabluchi", "PickGabLuchiAddSource", {
              appid,
              source: s.name,
            }).catch(function () {});
          };
    ...
    const timer = setInterval(function () {
      ...
      window.Millennium.callServerMethod("gabluchi", "GetGabLuchiAddStatus", { appid })
        .then(function (st) {
          if (typeof st === "string") st = JSON.parse(st);
          const overlay = document.querySelector(".gabluchi-overlay");
          if (!overlay) {
          ...
          const statusEl = q(".gabluchi-status");
          const titleEl = q(".gabluchi-title");
          const wrap = q(".gabluchi-progress-wrap");
          const bar = q(".gabluchi-progress-bar");
          const percent = q(".gabluchi-percent");
          ...
          if (st.installed || st.installStatus) {
            ...
            const hide = q(".gabluchi-hide-btn");
            if (hide) hide.innerHTML = "<span>" + lt("Close") + "</span>";
            // Game is added → remove the store-page "Add via GabLuchi" button.
            if (anchor && anchor.parentElement)
              anchor.parentElement.removeChild(anchor);
            window.__GabLuchiButtonInserted = false;
  ...
  backendLog("GabLuchi script loaded");
  backendLog(
    "Mode Detection: " +
      (window.__GABLUCHI_IS_BIG_PICTURE__ ? "BIG PICTURE MODE" : "NORMAL MODE"),
  );
  // anti-spam state
  const logState = {
    missingOnce: false,
  ...
  const runState = {
    inProgress: false,
    appid: null,
    pollTimer: null, // id of the active GetGabLuchiAddStatus setInterval, so cancel/close can stop it
  };
  ...
  function fetchGamesDatabase() {
    ...
    return Millennium.callServerMethod("gabluchi", "GetGamesDatabase", {
      contentScriptQuery: "",
    })
      .then(function (res) {
      ...
      .catch(function (err) {
        console.warn("[GabLuchi] Failed to fetch games database", err);
        return {};
      });
  }
  ...
  function fetchFixes(appid) {
    ...
    return Millennium.callServerMethod("gabluchi", "CheckForFixes", {
      appid: appid,
      contentScriptQuery: "",
    })
      .then(function (res) {
      ...
      .catch(function (err) {
        console.warn("[GabLuchi] Failed to fetch fixes", err);
        return null;
      });
  }
  ...
  function applyTranslationBundle(bundle) {
    ...
    const stored = window.__GabLuchiI18n || {};
    if (bundle.language) {
  ...
  function loadThemesFromBackend() {
    ...
    return Millennium.callServerMethod("gabluchi", "GetThemes", {
      contentScriptQuery: "",
    })
      .then(function (res) {
        try {
  ...
  function getCurrentThemeKey() {
    try {
      const settings = window.__GabLuchiSettings || {};
  ...
  // Minimal chrome: neutral hairlines and hover states derived from the theme's surface
  // darkness, so the UI reads clean on both dark and light themes instead of drowning in accent tint.
  function resolveNeutral(theme) {
    const base = hexToRgb(theme.bgPrimary);
    const light =
      base[0] * 0.299 + base[1] * 0.587 + base[2] * 0.114 > 140;
    return {
      hairline: light ? "rgba(15,23,32,0.18)" : "rgba(255,255,255,0.16)",
      hairlineSoft: light ? "rgba(15,23,32,0.08)" : "rgba(255,255,255,0.08)",
      hoverBg: light ? "rgba(15,23,32,0.06)" : "rgba(255,255,255,0.06)",
    };
  }
  ...
  function getThemeColors() {
    ...
    const neutral = resolveNeutral(theme);
    return {
      ...
      hairlineSoft: neutral.hairlineSoft,
      hoverBg: neutral.hoverBg,
      scrim: "rgba(8,12,16,0.5)",
  ...
  function generateThemeStyles(theme) {
    const neutral = resolveNeutral(theme);
    return `
            /* Force overlay backdrops to a neutral dark scrim (overrides inline styles) */
            .gabluchi-settings-overlay,
            .gabluchi-overlay,
            .gabluchi-loadedapps-overlay {
                background: rgba(8, 12, 16, 0.5) !important;
                backdrop-filter: blur(3px) !important;
            }

            /* Prefer overlay-scoped select rules to override theme CSS files */
            .gabluchi-settings-overlay select,
            .gabluchi-overlay select,
            .gabluchi-loadedapps-overlay select {
                background-color: ${theme.bgTertiary} !important;
                color: ${theme.text} !important;
                border: 1px solid ${neutral.hairline} !important;
                border-radius: 2px !important;
                padding: 5px 8px !important;
                font-size: 13px !important;
            }
            .gabluchi-settings-overlay select option,
            .gabluchi-overlay select option,
            .gabluchi-loadedapps-overlay select option {
                background-color: ${theme.bgPrimary} !important;
                color: ${theme.text} !important;
            }
            .gabluchi-settings-overlay select option:checked,
            .gabluchi-overlay select option:checked,
            .gabluchi-loadedapps-overlay select option:checked {
                background: ${theme.accent} !important;
                color: ${theme.text} !important;
            }
            .gabluchi-settings-overlay select:hover,
            .gabluchi-overlay select:hover,
            .gabluchi-loadedapps-overlay select:hover {
                border-color: ${neutral.hairline} !important;
                background-color: ${theme.bgHover} !important;
            }
            .gabluchi-settings-overlay select:focus,
            .gabluchi-overlay select:focus,
            .gabluchi-loadedapps-overlay select:focus {
            ...
            .gabluchi-btn {
                ...
                border: 1px solid ${neutral.hairline};
                border-radius: 5px;
                color: ${theme.text};
                font-size: 13px;
                font-weight: 500;
            ...
            .gabluchi-btn:hover:not([data-disabled="1"]) {
                background: ${neutral.hoverBg};
                border-color: ${neutral.hairline};
            }
            ...
            .gabluchi-toggle-container {
                display: flex;
                align-items: center;
                justify-content: space-between;
                width: 100%;
            }
            .gabluchi-toggle-label-wrap {
                display: flex;
            ...
            .gabluchi-slider {
                ...
                right: 0;
                bottom: 0;
                background-color: ${neutral.hairline};
                transition: .3s;
                border-radius: 24px;
            }
            .gabluchi-slider:before {
                position: absolute;
                content: "";
                height: 16px;
                width: 16px;
            ...
            /* Store header button - minimal ghost icon button */
            button.gabluchi-header-button {
                display: inline-flex;
                align-items: center;
            ...
            button.gabluchi-header-button img,
            button.gabluchi-header-button svg {
                height: 16px;
                width: 16px;
            }
        `;
  ...
  function ensureThemeStylesheet(themeKey) {
    ...
    try {
      ...
      backendLog("GabLuchi: Theme CSS injection failed: " + err);
    }
  }

  function ensureGabLuchiStyles() {
    const styleEl = document.getElementById("gabluchi-styles");
    ...
    if (styleEl) {
      ...
      try {
        ...
        style.id = "gabluchi-styles";
        style.textContent = styles;
        document.head.appendChild(style);
      } catch (err) {
        backendLog("GabLuchi: Styles injection failed: " + err);
      }
    }
  }

  function ensureFontAwesome() {
    if (document.getElementById("gabluchi-fontawesome")) return;
    try {
      const link = document.createElement("link");
      link.id = "gabluchi-fontawesome";
      link.rel = "stylesheet";
      link.href =
      ...
      backendLog("GabLuchi: Font Awesome injection failed: " + err);
    }
  }

  function showSettingsPopup() {
    if (
      document.querySelector(".gabluchi-settings-overlay") ||
      settingsMenuPending
    )
      return;
    ...
    ensureTranslationsLoaded(false)
      ...
      .finally(function () {
        ...
        if (document.querySelector(".gabluchi-settings-overlay")) return;

        try {
          const d = document.querySelector(".gabluchi-overlay");
          if (d) d.remove();
        } catch (_) {}
        ensureGabLuchiStyles();
        ensureFontAwesome();
        ...
        overlay.style.cssText =
          "position:fixed;inset:0;background:rgba(8,12,16,0.5);backdrop-filter:blur(3px);z-index:99999;display:flex;align-items:center;justify-content:center;";

        const modal = document.createElement("div");
        const colors = getThemeColors();
        modal.style.cssText = `position:relative;background:${colors.modalBg};color:${colors.text};border:1px solid ${colors.hairline};border-radius:6px;width:440px;padding:22px 24px;box-shadow:0 12px 40px rgba(0,0,0,0.45);animation:slideUp 0.15s ease-out;`;

        const header = document.createElement("div");
        header.style.cssText = `display:flex;justify-content:space-between;align-items:center;margin-bottom:18px;padding-bottom:14px;border-bottom:1px solid ${colors.hairlineSoft};`;

        const title = document.createElement("div");
        title.style.cssText = `display:flex;align-items:center;gap:9px;font-size:17px;color:${colors.text};font-weight:600;`;
        const titleIcon = document.createElement("img");
        titleIcon.style.cssText = "width:18px;height:18px;border-radius:3px;";
        titleIcon.alt = "GabLuchi";
        try {
          Millennium.callServerMethod("gabluchi", "GetIconDataUrl", {
            contentScriptQuery: "",
          }).then(function (res) {
            try {
              ...
              titleIcon.src =
                p && p.success && p.dataUrl
                  ? p.dataUrl
                  : "GabLuchi/gabluchi-icon.png";
            } catch (_) {
              titleIcon.src = "GabLuchi/gabluchi-icon.png";
            }
          });
        } catch (_) {
          titleIcon.src = "GabLuchi/gabluchi-icon.png";
        ...
        titleText.textContent = t("menu.title", "GabLuchi · Menu");
        ...
        function createIconButton(id, iconClass, titleKey, titleFallback) {
          ...
          btn.style.cssText = `display:flex;align-items:center;justify-content:center;width:38px;height:38px;background:transparent;border:1px solid transparent;border-radius:4px;color:${btnColors.textSecondary};font-size:17px;text-decoration:none;transition:background 0.15s ease, border-color 0.15s ease, color 0.15s ease;cursor:pointer;`;
          btn.innerHTML = '<i class="fa-solid ' + iconClass + '"></i>';
          btn.title = t(titleKey, titleFallback);
          btn.onmouseover = function () {
            this.style.background = btnColors.hoverBg;
            this.style.borderColor = btnColors.hairline;
            this.style.color = btnColors.text;
          };
          btn.onmouseout = function () {
            this.style.background = "transparent";
            this.style.borderColor = "transparent";
            this.style.color = btnColors.textSecondary;
          };
        ...
        if (window.__GABLUCHI_IS_BIG_PICTURE__) {
          const tip = document.createElement("div");
          tip.style.cssText =
            "background:rgba(255,255,255,0.05);border-left:2px solid rgba(255,255,255,0.2);padding:10px 14px;border-radius:4px;font-size:12.5px;color:rgba(199,213,224,0.9);margin-bottom:16px;line-height:1.5;";
          tip.innerHTML =
            '<i class="fa-solid fa-info-circle" style="margin-right:8px;color:rgba(199,213,224,0.7);"></i>' +
            t(
              "bigpicture.mouseTip",
        ...
        container.style.cssText =
          "margin-top:14px;display:flex;flex-direction:column;gap:8px;align-items:stretch;";
        ...
        function createCardButton(id, key, fallback, iconClass) {
          ...
          btn.href = "#";
          const btnColors = getThemeColors();
          btn.style.cssText = `display:flex;align-items:center;justify-content:flex-start;gap:10px;background:transparent;border:1px solid ${btnColors.hairline};border-radius:5px;color:${btnColors.text};font-size:13px;font-weight:500;text-decoration:none;transition:background 0.15s ease, border-color 0.15s ease;cursor:pointer;text-align:left;padding:10px 14px;min-width:0;width:100%;box-sizing:border-box;`;
          const iconHtml = iconClass
            ? '<i class="fa-solid ' +
              iconClass +
              '" style="font-size:14px;width:18px;text-align:center;color:' +
              btnColors.accent +
              ';flex-shrink:0;"></i>'
            : "";
          const textSpan =
          ...
          btn.onmouseover = function () {
            ...
            this.style.background = c.hoverBg;
            this.style.borderColor = c.hairline;
          };
          btn.onmouseout = function () {
            const c = getThemeColors();
            this.style.background = "transparent";
        ...
        removeBtn.style.cssText = `display:none;align-items:center;justify-content:center;gap:8px;padding:9px 14px;background:transparent;border:1px solid ${removeBtnColors.hairline};border-radius:5px;color:${removeBtnColors.textSecondary};font-size:13px;font-weight:500;text-decoration:none;transition:background 0.15s ease, border-color 0.15s ease;cursor:pointer;text-align:center;`;
        removeBtn.innerHTML =
          '<i class="fa-solid fa-trash-can" style="font-size:13px;color:rgba(255,107,107,0.9);"></i><span>' +
        ...
        cardGrid.style.cssText =
          "display:flex;flex-direction:column;gap:8px;justify-content:stretch;";
        ...
        const healthCheckBtn = createCardButton(
          "lt-settings-health-check",
          "menu.healthCheck",
          "Health Check",
          "fa-heart-pulse",
        );
        if (isGamePage) cardGrid.appendChild(healthCheckBtn);
        ...
        if (checkBtn) {
          checkBtn.addEventListener("click", function (e) {
            ...
            try {
              Millennium.callServerMethod("gabluchi", "CheckForUpdatesNow", {
                contentScriptQuery: "",
              }).then(function (res) {
                try {
                  const payload =
                  ...
                  ShowGabLuchiAlert("GabLuchi", msg);
                } catch (_) {}
              });
            } catch (_) {}
          });
        ...
        if (discordBtn) {
          discordBtn.addEventListener("click", function (e) {
            ...
            const url = "https://discord.gg/JVVDptutvf";
            try {
              Millennium.callServerMethod("gabluchi", "OpenExternalUrl", {
                url,
                contentScriptQuery: "",
              });
            } catch (_) {}
        ...
        if (settingsManagerBtn) {
          // Settings are managed entirely in the GabLuchi app — open its Settings
          ...
          settingsManagerBtn.addEventListener("click", function (e) {
            ...
            window.Millennium.callServerMethod("gabluchi", "OpenSettings", {}).catch(
              function () {},
            );
          });
        }
        ...
        if (fixesMenuBtn) {
          // Fixes are managed entirely in the GabLuchi app — open its Fixes page
          ...
          fixesMenuBtn.addEventListener("click", function (e) {
            ...
            try {
              ...
              const appid = match
                ? parseInt(match[1], 10)
                : window.__GabLuchiCurrentAppId || NaN;
              try {
                overlay.remove();
              } catch (_) {}
              if (isNaN(appid)) {
                ...
                ShowGabLuchiAlert("GabLuchi", errText);
                return;
              }
              window.Millennium.callServerMethod("gabluchi", "OpenFix", { appid }).catch(
                function () {},
              );
            } catch (err) {
              backendLog("GabLuchi: Fixes Menu button error: " + err);
            }
          });
        }
        ...
        if (healthCheckBtn) {
          healthCheckBtn.addEventListener("click", function (e) {
            ...
            try {
              ...
              if (isNaN(appid)) {
                ShowGabLuchiAlert("GabLuchi", t("menu.error.noAppId", "Could not determine game AppID"));
                return;
              }
              healthCheckBtn.querySelector("span").textContent = t("menu.checkingHealth", "Checking...");
        ...
        try {
          ...
          if (
            ...
            Millennium.callServerMethod("gabluchi", "HasGabLuchiForApp", {
              appid,
              contentScriptQuery: "",
            }).then(function (res) {
              try {
                ...
                if (exists) {
                    ...
                    try {
                      Millennium.callServerMethod(
                        ...
                        .then(function () {
                          try {
                            window.__GabLuchiButtonInserted = false;
                            window.__GabLuchiGameAdded = false;
                            window.__GabLuchiPresenceCheckInFlight = false;
                            window.__GabLuchiPresenceCheckAppId = undefined;
                            addGabLuchiButton(true);
                            const successText = t(
                              "menu.remove.success",
                              "GabLuchi removed for this app.",
                            );
                            ShowGabLuchiAlert("GabLuchi", successText);
                          } catch (err) {
                            backendLog(
                              "GabLuchi: post-delete cleanup failed: " + err,
                            );
                          }
                        })
                        .catch(function (err) {
                          const failureText = t(
                            "menu.remove.failure",
                            "Failed to remove GabLuchi.",
                          );
                          const errMsg =
                            err && err.message ? err.message : failureText;
                          ShowGabLuchiAlert("GabLuchi", errMsg);
                        });
                    } catch (err) {
                      backendLog("GabLuchi: doDelete failed: " + err);
                    }
                  };
                  ...
                  removeBtn.onclick = function (e) {
                    ...
                    const confirmMessage = t(
                      "menu.remove.confirm",
                      "Remove via GabLuchi for this game?",
                    );
                    showGabLuchiConfirm(
                      "GabLuchi",
                      confirmMessage,
  ...
  function ensureTranslationsLoaded(forceRefresh, preferredLanguage) {
    try {
      if (
        !forceRefresh &&
        window.__GabLuchiI18n &&
        window.__GabLuchiI18n.ready
      ) {
        return Promise.resolve(window.__GabLuchiI18n);
      }
      if (
        typeof Millennium === "undefined" ||
        typeof Millennium.callServerMethod !== "function"
      ) {
        window.__GabLuchiI18n = window.__GabLuchiI18n || {
          language: "en",
          locales: [],
          strings: {},
          ready: false,
      ...
      const settingsVals =
        ((window.__GabLuchiSettings || {}).values || {}).general || {};
      const useSteamLang =
      ...
      if (!targetLanguage) {
        ...
        targetLanguage = useSteamLang
          ? steamLang
          : (window.__GabLuchiI18n && window.__GabLuchiI18n.language) || "en";
      }
      return Millennium.callServerMethod("gabluchi", "GetTranslations", {
        ...
        .then(function (res) {
          ...
          return window.__GabLuchiI18n;
        })
        .catch(function (err) {
          backendLog("GabLuchi: translation load failed: " + err);
          window.__GabLuchiI18n = window.__GabLuchiI18n || {
            language: "en",
            locales: [],
            strings: {},
      ...
      backendLog("GabLuchi: ensureTranslationsLoaded error: " + err);
      window.__GabLuchiI18n = window.__GabLuchiI18n || {
        language: "en",
        locales: [],
        strings: {},
  ...
  function translateText(key, fallback) {
    ...
    try {
      const store = window.__GabLuchiI18n;
      if (
        store &&
        store.strings &&
  ...
  function askRestartConfirmation() {
    showGabLuchiConfirm(
      ...
      function () {
        try {
          Millennium.callServerMethod("gabluchi", "RestartSteam", {
            contentScriptQuery: "",
          });
  ...
  function showTestPopup() {
    // Avoid duplicates
    if (document.querySelector(".gabluchi-overlay")) return;
    // Close settings popup if open so modals don't overlap
    try {
      const s = document.querySelector(".gabluchi-settings-overlay");
      if (s) s.remove();
    } catch (_) {}
    ...
    const modal = document.createElement("div");
    const colors = getThemeColors();
    modal.style.cssText = `background:${colors.modalBg};color:${colors.text};border:1px solid ${colors.hairline};border-radius:6px;width:480px;padding:24px 26px;box-shadow:0 12px 40px rgba(0,0,0,0.45);animation:slideUp 0.15s ease-out;`;

    const title = document.createElement("div");
    const titleColors = getThemeColors();
    title.style.cssText = `display:flex;align-items:center;gap:9px;font-size:17px;color:${titleColors.text};margin-bottom:14px;font-weight:600;`;
    title.className = "gabluchi-title";
    const dlTitleIcon = document.createElement("i");
    dlTitleIcon.className = "fa-solid fa-cloud-arrow-down";
    dlTitleIcon.style.cssText = `color:${titleColors.accent};font-size:16px;`;
    ...
    apiListContainer.className = "gabluchi-api-list";
    apiListContainer.style.cssText = "margin-bottom:16px;";

    // NOTE: the source list is populated/updated by startGabLuchiAdd() from the
    ...
    const body = document.createElement("div");
    body.style.cssText = `display:flex;align-items:center;justify-content:center;gap:8px;font-size:13px;line-height:1.4;margin-bottom:10px;color:${colors.textSecondary};`;
    body.className = "gabluchi-status";
    body.innerHTML =
      '<i class="fa-solid fa-spinner" style="font-size:13px;animation: spin 1.5s linear infinite;"></i><span>' +
      lt("Checking availability…") +
      "</span>";

    const progressWrap = document.createElement("div");
    progressWrap.style.cssText = `background:rgba(0,0,0,0.35);height:4px;border-radius:2px;overflow:hidden;position:relative;display:none;margin-top:12px;`;
    ...
    progressInfo.className = "gabluchi-progress-info";

    const percent = document.createElement("span");
    percent.className = "gabluchi-percent";
    ...
    // .gabluchi-hide-btn so the poll's existing selector still finds it.
    const hideBtn = document.createElement("a");
    hideBtn.className = "gabluchi-btn gabluchi-hide-btn";
    ...
    function cleanup() {
      // The status poll (setInterval in startGabLuchiAdd) lives in another scope — this is the only place a
    ...
    function cancelOperation() {
      try {
        ...
        if (
          ...
          Millennium.callServerMethod("gabluchi", "CancelAddViaGabLuchi", {
            appid,
            contentScriptQuery: "",
          });
        }
  ...
  function fetchSettingsConfig(forceRefresh) {
    try {
      if (
        !forceRefresh &&
        window.__GabLuchiSettings &&
        Array.isArray(window.__GabLuchiSettings.schema)
      ) {
        return Promise.resolve(window.__GabLuchiSettings);
      }
    } catch (_) {}
    ...
    if (
      ...
      return Promise.reject(new Error(lt("GabLuchi backend unavailable")));
    }

    return Millennium.callServerMethod("gabluchi", "GetSettingsConfig", {
      contentScriptQuery: "",
    }).then(function (res) {
      const payload = typeof res === "string" ? JSON.parse(res) : res;
      ...
      window.__GabLuchiSettings = config;
      return config;
    });
  }
  ...
  function closeSettingsOverlay() {
    try {
      ...
      var list = document.getElementsByClassName("gabluchi-settings-overlay");
      ...
      var list2 = document.getElementsByClassName("gabluchi-overlay");
  ...
  function showGabLuchiAlert(title, message, onClose) {
    if (document.querySelector(".gabluchi-alert-overlay")) return;
    ...
    overlay.style.cssText =
      "position:fixed;inset:0;background:rgba(8,12,16,0.5);backdrop-filter:blur(3px);z-index:100001;display:flex;align-items:center;justify-content:center;";

    const modal = document.createElement("div");
    const alertModalColors = getThemeColors();
    modal.style.cssText = `background:${alertModalColors.modalBg};color:${alertModalColors.text};border:1px solid ${alertModalColors.hairline};border-radius:6px;width:400px;padding:24px 26px;box-shadow:0 12px 40px rgba(0,0,0,0.45);animation:slideUp 0.15s ease-out;`;

    const alertIconWrap = document.createElement("div");
    alertIconWrap.style.cssText = "text-align:center;margin-bottom:10px;";
    const alertIcon = document.createElement("i");
    alertIcon.className = "fa-solid fa-circle-info";
    alertIcon.style.cssText = `color:${alertModalColors.accent};font-size:24px;`;
    alertIconWrap.appendChild(alertIcon);

    const titleEl = document.createElement("div");
    titleEl.style.cssText = `font-size:17px;color:${alertModalColors.text};margin-bottom:10px;font-weight:600;text-align:center;`;
    titleEl.textContent = String(title || "GabLuchi");

    const messageEl = document.createElement("div");
    messageEl.style.cssText = `font-size:13px;line-height:1.6;margin-bottom:20px;color:${alertModalColors.textSecondary};text-align:center;`;
    ...
    okBtn.href = "#";
    okBtn.className = "gabluchi-btn primary";
    okBtn.style.cssText =
  ...
  function ShowGabLuchiAlert(title, message) {
    try {
      showGabLuchiAlert(title, message);
    } catch (err) {
      backendLog("GabLuchi: Alert error, falling back: " + err);
      try {
        alert(String(title) + "\n\n" + String(message));
      } catch (_) {}
    }
  ...
  function showGabLuchiConfirm(title, message, onConfirm, onCancel) {
    // Always close settings popup first so the confirm is visible on top
    closeSettingsOverlay();

    // Create custom modern confirmation dialog
    if (document.querySelector(".gabluchi-confirm-overlay")) return;
    ...
    modal.style.cssText = `background:${confirmColors.modalBg};color:${confirmColors.text};border:1px solid ${confirmColors.hairline};border-radius:6px;width:400px;padding:24px 26px;box-shadow:0 12px 40px rgba(0,0,0,0.45);animation:slideUp 0.15s ease-out;`;

    const confirmIconWrap = document.createElement("div");
    confirmIconWrap.style.cssText = "text-align:center;margin-bottom:10px;";
    const confirmIcon = document.createElement("i");
    confirmIcon.className = "fa-solid fa-circle-question";
    confirmIcon.style.cssText = `color:${confirmColors.accent};font-size:24px;`;
    confirmIconWrap.appendChild(confirmIcon);

    const titleEl = document.createElement("div");
    titleEl.style.cssText = `font-size:17px;color:${confirmColors.text};margin-bottom:10px;font-weight:600;text-align:center;`;
    titleEl.textContent = String(title || "GabLuchi");

    const messageEl = document.createElement("div");
    messageEl.style.cssText = `font-size:13px;line-height:1.6;margin-bottom:20px;color:${confirmColors.textSecondary};text-align:center;`;
    ...
    cancelBtn.href = "#";
    cancelBtn.className = "gabluchi-btn";
    ...
    confirmBtn.href = "#";
    confirmBtn.className = "gabluchi-btn primary";
  ...
  function ensureStyles() {
    if (!document.getElementById("gabluchi-spacing-styles")) {
      const style = document.createElement("style");
      style.id = "gabluchi-spacing-styles";
      style.textContent = `
                .gabluchi-restart-button { margin-left: 0 !important; margin-right: 3px !important; }
                .gabluchi-button { margin-left: 0 !important; margin-right: 0 !important; position: relative !important; }
                .gabluchi-pills-container {
                ...
                .gabluchi-pill.red { background: rgba(255, 80, 80, 0.15); color: #ff5050; border: 1px solid rgba(255, 80, 80, 0.3); }
                .gabluchi-pill.green { background: rgba(92, 184, 92, 0.15); color: #5cb85c; border: 1px solid rgba(92, 184, 92, 0.3); }
                .gabluchi-pill.yellow { background: rgba(255, 193, 7, 0.15); color: #ffc107; border: 1px solid rgba(255, 193, 7, 0.3); }
                .gabluchi-pill.orange { background: rgba(255, 136, 0, 0.15); color: #ff8800; border: 1px solid rgba(255, 136, 0, 0.3); }
            `;
  ...
  function updateButtonTranslations() {
    try {
      ...
      const restartBtn = document.querySelector(".gabluchi-restart-button");
      if (restartBtn) {
      ...
      // Update Add via GabLuchi button
      const gabluchiBtn = document.querySelector(".gabluchi-button");
      if (gabluchiBtn) {
        const label = lt("Add via GabLuchi");
        gabluchiBtn.title = label;
        gabluchiBtn.setAttribute("data-tooltip-text", label);
        const span = gabluchiBtn.querySelector("span");
        if (span) {
          span.textContent = label;
        }
      }
    } catch (err) {
      backendLog("GabLuchi: updateButtonTranslations error: " + err);
    }
  }

  // Function to add the GabLuchi button
  ...
  function addGabLuchiButton(force) {
    ...
    // swallowed, or the "Add via GabLuchi" button intermittently never gets inserted.
    const now = Date.now();
    ...
    if (window.__GabLuchiLastUrl !== currentUrl) {
      // Page changed - reset button insertion flag and update translations
      window.__GabLuchiLastUrl = currentUrl;
      window.__GabLuchiButtonInserted = false;
      window.__GabLuchiGameAdded = false;
      window.__GabLuchiRestartInserted = false;
      window.__GabLuchiIconInserted = false;
      window.__GabLuchiHeaderInserted = false;
      window.__GabLuchiPresenceCheckInFlight = false;
      window.__GabLuchiPresenceCheckAppId = undefined;
    ...
    if (
      headerContainer &&
      !document.querySelector(".gabluchi-header-button") &&
      !window.__GabLuchiHeaderInserted
    ) {
      ensureGabLuchiStyles();
      const headerBtn = document.createElement("button");
      headerBtn.type = "button";
      headerBtn.className = "gabluchi-header-button Focusable";
      headerBtn.tabIndex = "0";
      headerBtn.title = "GabLuchi Settings";
      headerBtn.setAttribute("data-tooltip-text", "GabLuchi Settings");
      ...
      window.__GabLuchiHeaderInserted = true;
      backendLog("Inserted store header button");
    }

    // Check if we're in Big Picture mode
    const isBigPicture = window.__GABLUCHI_IS_BIG_PICTURE__;
    ...
    if (targetContainer) {
      ...
      const ltPinButtons = function (c) {
        try {
          const rb = c.querySelector(".gabluchi-restart-button");
          const ab = c.querySelector(".gabluchi-button");
          if (rb && ab) {
      ...
      if (window.__GabLuchiOrderObservedEl !== steamdbContainer) {
        try {
          if (window.__GabLuchiOrderObserver) window.__GabLuchiOrderObserver.disconnect();
          const obs = new MutationObserver(function () { ltPinButtons(steamdbContainer); });
          obs.observe(steamdbContainer, { childList: true });
          window.__GabLuchiOrderObserver = obs;
          window.__GabLuchiOrderObservedEl = steamdbContainer;
        } catch (_) {}
      }

      // Insert a Restart Steam button between Community Hub and our GabLuchi button
      try {
        if (
          !document.querySelector(".gabluchi-restart-button") &&
          !window.__GabLuchiRestartInserted
        ) {
          ensureStyles();
          ...
          if (referenceBtn && referenceBtn.className) {
            restartBtn.className =
              referenceBtn.className + " gabluchi-restart-button";
          } else {
            restartBtn.className =
              "btnv6_blue_hoverfade btn_medium gabluchi-restart-button";
          }
          restartBtn.href = "#";
          const restartText = lt("Restart Steam");
          restartBtn.title = restartText;
          ...
          window.__GabLuchiRestartInserted = true;
      ...
      const existingBtn = document.querySelector(".gabluchi-button");
      if (existingBtn) {
        ensureTranslationsLoaded(false).then(function () {
          updateButtonTranslations();
        });
      ...
      if (!existingBtn && !window.__GabLuchiButtonInserted) {
        // Create the GabLuchi button modeled after existing SteamDB/PCGW buttons
        // In Big Picture mode, use queue button as reference; otherwise use first link in container
        ...
        // Use same custom button for both modes
        const gabluchiButton = document.createElement("a");
        gabluchiButton.href = "#";
        // Copy classes from an existing button to match look-and-feel, but set our own label
        if (referenceBtn && referenceBtn.className) {
          gabluchiButton.className =
            referenceBtn.className + " gabluchi-button";
        } else {
          gabluchiButton.className =
            "btnv6_blue_hoverfade btn_medium gabluchi-button";
        }
        const span = document.createElement("span");
        const addViaText = lt("Add via GabLuchi");
        span.textContent = addViaText;
        gabluchiButton.appendChild(span);
        // Tooltip/title
        gabluchiButton.title = addViaText;
        gabluchiButton.setAttribute("data-tooltip-text", addViaText);

        // Normalize margins to match native buttons
        try {
          if (referenceBtn) {
            const cs = window.getComputedStyle(referenceBtn);
            gabluchiButton.style.marginLeft = cs.marginLeft;
            gabluchiButton.style.marginRight = cs.marginRight;
          }
        } catch (_) {}

        // Local click handler suppressed; delegated handler manages actions
        gabluchiButton.addEventListener("click", function (e) {
          e.preventDefault();
          backendLog(
            "GabLuchi button clicked (delegated handler will process)",
          );
        });

        // Before inserting, ask backend if GabLuchi already exists for this appid
        try {
          const match =
            window.location.href.match(
              /https:\/\/store\.steampowered\.com\/app\/(\d+)/,
          ...
          if (
            ...
            // If HasGabLuchiForApp never settles (a slow/hung backend round-trip has been
            ...
            if (
              window.__GabLuchiPresenceCheckInFlight &&
              window.__GabLuchiPresenceCheckAppId === appid &&
              Date.now() - (window.__GabLuchiPresenceCheckAt || 0) < 8000
            ) {
              return;
            }
            window.__GabLuchiPresenceCheckInFlight = true;
            window.__GabLuchiPresenceCheckAt = Date.now();
            window.__GabLuchiPresenceCheckAppId = appid;
            window.__GabLuchiCurrentAppId = appid;
            window.Millennium.callServerMethod("gabluchi", "HasGabLuchiForApp", { appid })
              ...
              try {
                ...
                // lives in the GabLuchi menu). Only show "Add via GabLuchi" when the
                // game is NOT yet added.
                if (payload && payload.success && payload.exists === true) {
                  backendLog(
                    "GabLuchi already present for this app; not inserting button",
                  );
                  // Resolved: game is already added, so the Add button is intentionally
                  // omitted. Mark it so ensureGabLuchiUI stops retrying (button will never
                  // appear, and that's correct) instead of spinning to the attempt cap.
                  window.__GabLuchiGameAdded = true;
                  window.__GabLuchiPresenceCheckInFlight = false;
                  return;
                }
                if (
                  !document.querySelector(".gabluchi-button") &&
                  !window.__GabLuchiButtonInserted
                ) {
                  // Insert after restart button (order: Restart → Add)
                  const restartExisting = steamdbContainer.querySelector(
                    ".gabluchi-restart-button",
                  );
                  if (restartExisting && restartExisting.after) {
                    restartExisting.after(gabluchiButton);
                  } else if (referenceBtn && referenceBtn.after) {
                    referenceBtn.after(gabluchiButton);
                  } else {
                    steamdbContainer.appendChild(gabluchiButton);
                  }
                  window.__GabLuchiButtonInserted = true;
                  backendLog("GabLuchi button inserted");
                }
                window.__GabLuchiPresenceCheckInFlight = false;
              } catch (_) {
                if (
      ...
      try {
        ...
        if (!isNaN(appid)) {
          const pillBtn = steamdbContainer.querySelector(".gabluchi-button");
          if (pillBtn) {
            ...
            if (
              ...
              fetchGamesDatabase().then(function (db) {
                const btn = steamdbContainer.querySelector(".gabluchi-button");
                if (!btn) return;
                ...
                if (!pillsContainer) {
                  ...
                  pillsContainer.className = "gabluchi-pills-container";
                ...
                fetchFixes(appid).then(function (fixesData) {
                  ...
                  if (showDenuvoPill) {
                    const pill = document.createElement("span");
                    pill.className = "gabluchi-pill orange";
      ...
      if (!logState.missingOnce) {
        backendLog("GabLuchi: steamdbContainer not found on this page");
        logState.missingOnce = true;
      }
    }
  }

  // Retry addGabLuchiButton() until its DOM containers exist, instead of the previous single silent
  ...
  // actually runs addGabLuchiButton's body instead of being silently throttled away.
  //
  // window.__GabLuchiReady only gets set once this settles (header button confirmed present, or retries
  ...
  function ensureGabLuchiUI(attempt) {
    attempt = attempt || 0;
    try {
      addGabLuchiButton(true);
    } catch (err) {
      backendLog("GabLuchi: ensureGabLuchiUI attempt " + attempt + " threw: " + err);
    }
    ...
    var headerReady = !!document.querySelector(".gabluchi-header-button");
    if (headerReady || attempt >= 12) {
      window.__GabLuchiReady = true;
      return;
    }
    setTimeout(function () {
      ensureGabLuchiUI(attempt + 1);
    }, 600);
  }
  ...
  function onFrontendReady() {
    ...
    setTimeout(function () {
      if (
        ...
        backendLog("[GabLuchi] Gamepad detected - Navigation enabled");

        // Only show visual hint in Big Picture mode
        if (window.__GABLUCHI_IS_BIG_PICTURE__) {
          const hint = document.createElement("div");
          hint.id = "gabluchi-gamepad-hint";
          ...
          if (!document.querySelector("#gabluchi-gamepad-hint-styles")) {
            const style = document.createElement("style");
            style.id = "gabluchi-gamepad-hint-styles";
            style.textContent =
              "\
                            @keyframes fadeInOut {\
    ...
    try {
      if (
        ...
        Millennium.callServerMethod("gabluchi", "GetInitApisMessage", {
          contentScriptQuery: "",
        }).then(function (res) {
          try {
            const payload = typeof res === "string" ? JSON.parse(res) : res;
        ...
        try {
          if (window.location.hostname === "store.steampowered.com") {
            if (!sessionStorage.getItem("GabLuchiLoadedAppsGate")) {
              sessionStorage.setItem("GabLuchiLoadedAppsGate", "1");
              Millennium.callServerMethod("gabluchi", "ReadLoadedApps", {
                contentScriptQuery: "",
              }).then(function (res) {
                try {
                  const payload =
  ...
  document.addEventListener(
    ...
    function (evt) {
      ...
      const anchor = evt.target.closest(".gabluchi-button");
      if (anchor) {
        evt.preventDefault();
        evt.stopPropagation(); // Stop propagation to avoid conflicts
        backendLog("GabLuchi delegated click");
        try {
          const match =
            window.location.href.match(
              /https:\/\/store\.steampowered\.com\/app\/(\d+)/,
          ...
          if (
            ...
            if (runState.inProgress && runState.appid === appid) {
              backendLog(
                "GabLuchi: operation already in progress for this appid",
              );
              return;
            }

            // "Add via GabLuchi": reflect the app's real add pipeline in the popup
            // (dynamic sources, Hubcap/key-gating, usage, FastFetch, progress),
            // headless. Removal is handled from the GabLuchi menu, not this button.
            startGabLuchiAdd(appid, anchor);
            return;
          }
        } catch (_) {}
      }
  ...
  function bootSettings() {
    ...
    loadThemes().then(function() {
        ...
        if (typeof ensureGabLuchiStyles === "function") ensureGabLuchiStyles();
    }).catch(function(e) {
        try { backendLog("GabLuchi: Boot sequence failed: " + String(e)); } catch(_) {}
    });
  }
  bootSettings();
  ...
  function showLoadedAppsPopup(apps) {
    // Avoid duplicates
    if (document.querySelector(".gabluchi-loadedapps-overlay")) return;
    ensureFontAwesome();
    ensureGabLuchiStyles();
    const overlay = document.createElement("div");
    ...
    modal.style.cssText = `background:${loadedAppsModalColors.modalBg};color:${loadedAppsModalColors.text};border:1px solid ${loadedAppsModalColors.hairline};border-radius:6px;width:500px;padding:24px 26px;box-shadow:0 12px 40px rgba(0,0,0,0.45);animation:slideUp 0.15s ease-out;`;
    const title = document.createElement("div");
    const loadedAppsTitleColors = getThemeColors();
    title.style.cssText = `font-size:17px;color:${loadedAppsTitleColors.text};margin-bottom:16px;font-weight:600;text-align:left;`;
    title.textContent = lt("GabLuchi · Added Games");
    const body = document.createElement("div");
    const loadedAppsBodyColors = getThemeColors();
    body.style.cssText = `font-size:14px;line-height:1.8;margin-bottom:16px;max-height:320px;overflow:auto;padding:6px;border:1px solid ${loadedAppsBodyColors.hairline};border-radius:6px;background:rgba(0,0,0,0.18);`;
    if (apps && apps.length) {
      ...
      apps.forEach(function (item) {
        ...
        a.style.cssText = `display:block;color:${linkColors.text};text-decoration:none;padding:9px 12px;margin-bottom:6px;background:transparent;border:1px solid transparent;border-radius:4px;transition:background 0.15s ease, border-color 0.15s ease, color 0.15s ease;`;
    ...
    dismissBtn.className = "gabluchi-btn";
    dismissBtn.innerHTML = "<span>" + lt("Dismiss") + "</span>";
    dismissBtn.href = "#";
    dismissBtn.onclick = function (e) {
      e.preventDefault();
      try {
        Millennium.callServerMethod("gabluchi", "DismissLoadedApps", {
          contentScriptQuery: "",
        });
      } catch (_) {}
      try {
        sessionStorage.setItem("GabLuchiLoadedAppsShown", "1");
      } catch (_) {}
      overlay.remove();
    };
  ...
  // window.__GabLuchiReady (the completion marker CefInjectorService's polling loop checks — see
  // ensureGabLuchiUI() above) is set there once the button/icon setup actually settles, not here
